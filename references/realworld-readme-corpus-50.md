...
- Expand the README validation corpus from a 5-repo smoke set to a 50-repo balanced set.
...
- Keep a 10-repo smoke subset for fast iteration and a 50-repo extended corpus for stricter validation.
